				...
				<tr>
					...
					<td colspan="3">
						<input type="text" class="form-control" id="title" placeholder="제목을 입력해주세요."
							value="<%=fbv.getFaqTitle() %>">
					</td>
				</tr>
				<tr>
					<th>내용</th>
					<td colspan="3"><textarea class="form-control" id="content" rows="20"
							placeholder="내용을 입력해주세요."><%=fbv.getFaqContent() %></textarea></td>
				</tr>
				<%
				...
				<tr>
					...
					<td>
						<form id="fm" enctype="multipart/form-data">
							<input type="hidden" id="fmNm" name="faqNm">
