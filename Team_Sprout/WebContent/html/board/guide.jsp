		...
		<b>프로젝트 등록이 막막하시다면 프로젝트 가이드를 이용해보세요!</b>
			...
			<div class="panel panel-default">
				...
				<div id="collapse3" class="panel-collapse collapse">
					<div class="panel-body">텀블벅은 창작자님의 다양한 창작활동을 응원합니다. 창작물을
			...
			<div class="panel panel-default">
				...
				<div id="collapse4" class="panel-collapse collapse">
					<div class="panel-body">처음 프로젝트를 진행하는 창작자님께서는 한 번에 하나의 프로젝트만
						진행할 수 있습니다. 또한 모든 창작자는 텀블벅 프로젝트를 진행하는 동안 다른 모금 플랫폼이나 SNS 등을 통해 동일한
			...
			<div class="panel panel-default">
				...
				<div id="collapse5" class="panel-collapse collapse">
					<div class="panel-body">
						모집이 성사된 프로젝트에 한해 모금액의 5%를 유지비용으로 수수하고 있습니다. 텀블벅 플랫폼 수수료는 총 모금액의
