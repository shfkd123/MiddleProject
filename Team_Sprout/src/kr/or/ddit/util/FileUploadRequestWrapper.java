...
public class FileUploadRequestWrapper extends HttpServletRequestWrapper {
    public static final String UPLOAD_DIRECTORY = "E:/A_TeachingMaterial/4.MiddleProject/workspace1/Team_Sprout/WebContent/attachfile";// 업로드 경로 설정
        ...
        if (ServletFileUpload.isMultipartContent(request)) {
            ...
            for (int i = 0 ; i < list.size(); i++) {
                ...
                if (fileItem.isFormField()) { // 폼필드인 경우...
                	...
                	if(fileItem.getSize() > 0) { // 파일이 존재하는 경우... 정상적인 파일인지 체크
